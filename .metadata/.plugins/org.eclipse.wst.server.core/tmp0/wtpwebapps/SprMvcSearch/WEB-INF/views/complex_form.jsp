			...
			<div class="col-md-8 offset-md-2">
				<div class="card">
					...
					<form action="handleForm" method="post">
						<div class="container mt-2" class="form-handle">
						...
						<div class="container mt-2" class="form-group">
						...
						<div class="container mt-2" class="form-group">
							...
							<div class="container mt-2" class="form-group">
								<label for="">Select Type</label> <select class="form-control"
									name="type">
									<option value="Existing Student">Already a user</option>
									<option value="New Student">New user</option>
								</select>
							</div>
